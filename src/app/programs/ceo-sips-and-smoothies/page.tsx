...
export default function SipsAndGrowthExecutiveReceptionPage() {
    ...
    const sectionCta = () => (
        <div className="mt-16 flex justify-center px-4">
            <button
                ...
                className="group relative w-full sm:w-auto px-10 py-5 bg-[#88C52A] text-[#2F2F2F] rounded-none font-bold text-lg sm:text-xl hover:bg-[#7AB52E] transition-all transform hover:scale-105 active:scale-95 overflow-hidden shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] inline-block"
            >
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <section className="relative min-h-screen flex items-center pt-16 pb-16 overflow-hidden bg-[#2F2F2F] text-[#F2F1EB]">
                    ...
                    <div className="max-w-4xl lg:max-w-7xl">
                        {sips.hero.eyebrow && (
                            <div className="inline-block mb-6 animate-fade-in-up">
                                <span className="text-xs font-bold uppercase tracking-[0.4em] bg-white/10 border border-[#2F2F2F] px-6 py-2.5 rounded-none text-[#88C52A] shadow-[6px_6px_0px_0px_#2F2F2F]">
                                    {sips.hero.eyebrow}
                                </span>
                            </div>
                        )}
                        ...
                        <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-bold font-heading leading-[0.85] mb-6 animate-fade-in-up tracking-tighter">
                            {Array.isArray(sips.hero.h1) ? sips.hero.h1.map((line, i) => (
                                <span key={i} className={`block leading-[0.85] ${i === 0 ? "text-[#88C52A]" : "text-white"} ${i === 2 ? "text-3xl sm:text-5xl md:text-7xl lg:text-8xl mt-2 md:mt-3 lg:mt-4" : ""}`}>
                                    {line}
                                </span>
                            )) : sips.hero.h1}
                        </h1>

                        <div className="text-lg md:text-2xl font-heading mb-4 text-gray-200 max-w-2xl animate-fade-in-up delay-100 border-l-2 border-[#88C52A] pl-6 py-2 whitespace-pre-line">
                            {sips.hero.subtitle}
                        </div>

                        {/* Reassurance line rescued from the deleted "Social Context" section */}
                        <p className="text-base md:text-lg text-[#88C52A] font-bold mb-8 max-w-2xl animate-fade-in-up delay-100 pl-6">
                            A social, peer-level evening — not a pitch, not a sales event.
                        </p>

                        {/* Ticket-style Details */}
                        <div className="flex flex-wrap items-center gap-y-6 gap-x-12 mb-8 animate-fade-in-up delay-200 bg-white/5 border border-[#2F2F2F] p-6 md:p-8 rounded-none max-w-fit">
                            {sips.hero.details.map((detail, i) => (
                                <div key={i} className={`relative ${i === 0 ? "pr-0 md:pr-12" : ""}`}>
                                    <span className="text-[11px] md:text-[10px] uppercase tracking-[0.3em] text-[#88C52A] font-bold block mb-2">
                                        {i === 0 ? "When" : "Where"}
                                    </span>
                        ...
                        <button type="button" onClick={openBooking} aria-haspopup="dialog" className="group relative px-10 py-5 bg-[#88C52A] text-[#2F2F2F] rounded-none font-bold text-xl hover:bg-[#7AB52E] transition-all transform hover:scale-105 active:scale-95 animate-fade-in-up delay-300 overflow-hidden shadow-[8px_8px_0px_0px_#2F2F2F] inline-block">
            ...
            <section className="py-24 px-4 bg-gray-50/50">
                <div className="sips-container mx-auto">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <span className="text-[#88C52A] font-bold tracking-[0.3em] uppercase text-xs block mb-4">
                                EXECUTIVE SOCIAL
                            </span>
                            ...
                            <p className="text-xl md:text-2xl font-sans leading-relaxed mb-10 text-[#2F2F2F]">
                                {sips.socialContext.body}
                            </p>

                            <div className="grid sm:grid-cols-2 gap-4 mb-10">
                                {sips.socialContext.offerings.map((item: string, i: number) => (
                                    <div key={i} className="group bg-white p-5 rounded-none border-l-4 border-[#88C52A] shadow-[4px_4px_0px_0px_#88C52A] border-[3px] border-[#2F2F2F] hover:shadow-[4px_4px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] transition-all">
                                        <p className="text-base md:text-lg font-sans font-medium leading-snug group-hover:text-[#88C52A] transition-colors">
                                            {item}
                                        </p>
                                    </div>
                                ))}
                            ...
                            <p className="text-xl text-[#2F2F2F] italic font-sans font-semibold border-t border-gray-200 pt-8">
                                {sips.socialContext.footer}
                            </p>
                        </div>
                        <div className="relative">
                            <div className="absolute inset-0 bg-[#88C52A]/5 rounded-none rotate-3 scale-105" />
                            <Image
                                src="/executive_lounge_vibe_1769639909462.webp"
                                alt="Executive Social Atmosphere"
                                width={800}
                                height={1000}
                                className="relative z-10 rounded-none shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] object-cover aspect-[4/5]"
                            />
                        </div>
                    </div>
                    {sectionCta()}
            ...
            <section className="relative w-full py-16 md:py-24 px-4 md:px-8 bg-white z-10 overflow-hidden">
                <div className="sips-container mx-auto relative px-4 lg:px-8 max-w-7xl">
                    <div className="text-center mb-16 relative z-20">
                        ...
                        <p className="text-lg md:text-xl font-sans text-[#2F2F2F] font-medium leading-relaxed max-w-4xl mx-auto mb-10 text-balance">
                            {sips.eveningProgram.intro}
                        </p>

                        {/* Qualification gate - set the bar before the visitor invests time reading the agenda */}
                        <div className="bg-[#2F2F2F] text-white max-w-3xl mx-auto p-5 md:p-6 border-[3px] border-[#88C52A] shadow-[8px_8px_0px_0px_#88C52A] text-left mb-12">
                            <p className="text-xs md:text-sm uppercase tracking-[0.3em] text-[#88C52A] font-bold mb-2">
                                You&apos;re a Fit If
                            </p>
                    ...
                    {(() => {
                        const renderNewsCard = (item: AgendaItem, index: number, imagePosition: 'left' | 'right' = 'left') => {
                            ...
                            return (
                                <div key={index} className="w-full h-full bg-white border-[3px] border-[#2F2F2F] shadow-[8px_8px_0px_0px_#2F2F2F] group-hover:-translate-y-1 group-hover:shadow-[10px_10px_0px_0px_#88C52A] hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_#88C52A] transition-all duration-300 overflow-hidden group">
                                    <div className="p-6 md:p-8 w-full h-full">

                                        <div className="block mb-4">
                                            <span className="font-black text-2xl md:text-3xl text-[#2F2F2F] tracking-wider opacity-30 group-hover:opacity-100 group-hover:text-[#88C52A] transition-all duration-300 align-middle mr-4 inline-block">{item.number}</span>
                                            <span className="font-bold font-heading text-lg md:text-xl text-[#2F2F2F] border-l-[3px] border-[#2F2F2F] pl-4 py-1 leading-none align-middle inline-block">{item.time}</span>
                                        </div>

                                        {item.subtitle && (
                                            <div className="mb-3">
                                                <span className="inline-block px-3 py-1 font-bold text-xs tracking-[0.08em] sm:tracking-[0.2em] uppercase border-[2px] border-[#2F2F2F] bg-gray-50 text-[#2F2F2F] shadow-[3px_3px_0px_0px_#2F2F2F]">
                                                    {item.subtitle}
                                                </span>
                                            </div>
                                        )}

                                        <h3 className="text-xl sm:text-2xl lg:text-3xl font-black font-heading mb-3 text-[#2F2F2F] leading-tight group-hover:text-[#88C52A] transition-colors duration-300">
                                        ...
                                        {images.length > 0 && item.imageDirection.trim() !== '' && (
                                            <div className={`relative w-full h-48 sm:w-40 sm:h-40 md:w-48 md:h-48 mb-4 sm:mb-3 lg:mb-4 ${imagePosition === 'left' ? 'sm:float-left sm:mr-5 lg:mr-6' : 'sm:float-right sm:ml-5 lg:ml-6'} shadow-[4px_4px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] overflow-hidden group-hover:-translate-y-1 group-hover:shadow-[6px_6px_0px_0px_#88C52A] transition-all duration-300 bg-[#f8f9fa]`}>
                        ...
                        const renderCard = (item: AgendaItem, index: number, isHalf: boolean) => {
                            ...
                            return (
                                <div key={index} className={`w-full h-full bg-white border-[3px] border-[#2F2F2F] shadow-[8px_8px_0px_0px_#2F2F2F] group-hover:-translate-y-1 group-hover:shadow-[10px_10px_0px_0px_#88C52A] hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_#88C52A] transition-all duration-300 overflow-hidden flex flex-col ${isHalf || !hasImage ? '' : 'lg:flex-row'} group`}>

                                    {/* Text Content */}
                                    <div className={`p-6 md:p-10 flex flex-col justify-center ${isHalf || !hasImage ? 'w-full' : 'lg:w-1/2 flex-grow'}`}>
                                        <div className="flex items-center gap-4 mb-5">
                                            <span className="font-black text-3xl md:text-4xl text-[#2F2F2F] tracking-wider opacity-30 group-hover:opacity-100 group-hover:text-[#88C52A] transition-all duration-300">{item.number}</span>
                                            <span className="font-bold font-heading text-xl md:text-2xl text-[#2F2F2F] border-l-[3px] border-[#2F2F2F] pl-4 leading-none">{item.time}</span>
                                        </div>

                                        {item.subtitle && (
                                            <div className="mb-4">
                                                <span className="inline-block px-3 py-1 font-bold text-xs tracking-[0.08em] sm:tracking-[0.2em] uppercase border-[2px] border-[#2F2F2F] bg-gray-50 text-[#2F2F2F] shadow-[4px_4px_0px_0px_#2F2F2F]">
                                                    {item.subtitle}
                                                </span>
                                            </div>
                                        )}

                                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black font-heading mb-4 text-[#2F2F2F] leading-tight group-hover:text-[#88C52A] transition-colors duration-300">
                                    ...
                                    {/* Image(s) */}
                                    {hasImage && (
                                        <div className={`${isHalf ? 'w-full border-t-[3px]' : 'w-full lg:w-1/2 border-t-[3px] lg:border-t-0 lg:border-l-[3px]'} border-[#2F2F2F] bg-[#88C52A]/5 p-6 md:p-10 flex items-center justify-center`}>
                                            <div className={`relative w-full ${item.imageType === 'custom_concept' ? 'aspect-square' : 'h-full min-h-[300px] lg:min-h-[400px]'} ${item.imageType === 'logo_pair' || item.imageType === 'logo_triple' ? 'flex items-center justify-center gap-6' : 'shadow-[6px_6px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] overflow-hidden group-hover:-translate-y-1 group-hover:shadow-[8px_8px_0px_0px_#88C52A] transition-all duration-300'}`}>
            ...
            <section className="py-32 px-4 bg-gray-50/50 relative overflow-hidden">
                <div className="absolute top-[20%] right-[-10%] w-[40%] h-[40%] bg-[#88C52A]/5 rounded-none pointer-events-none" />
                    ...
                    <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-center">
                        <div className="lg:col-span-5 order-2 lg:order-1 relative h-[500px] sm:h-[700px] lg:h-[950px] flex flex-col justify-between">
                            <div className="relative w-full h-[30%] z-20 group/img1 animate-fade-in-up">
                                <div className="absolute inset-0 bg-[#88C52A]/10 rounded-none rotate-1 scale-105 group-hover/img1:rotate-0 group-hover/img1:scale-105 transition-all duration-700" />
                                <div className="relative rounded-none overflow-hidden shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] h-full">
                            ...
                            <div className="flex gap-6 h-[55%]">
                                <div className="w-1/2 h-full pt-12 animate-fade-in-up delay-200">
                                    <div className="relative h-[85%] group/img2">
                                        <div className="relative rounded-none overflow-hidden shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] h-full border-4 border-white">
                                ...
                                <div className="w-1/2 h-full pb-12 animate-fade-in-up delay-400">
                                    <div className="relative h-[85%] mt-auto group/img3">
                                        <div className="absolute inset-0 bg-[#88C52A]/5 rounded-none rotate-2 scale-105 group-hover/img3:rotate-0 transition-all duration-700" />
                                        <div className="relative rounded-none overflow-hidden shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] h-full border-4 border-white">
                            ...
                            <div className="relative w-full text-center mt-8 pb-4">
                                <button type="button" onClick={openBooking} aria-haspopup="dialog" className="group relative px-8 py-4 bg-[#88C52A] text-[#2F2F2F] rounded-none font-bold text-lg hover:bg-[#7AB52E] transition-all transform hover:scale-105 active:scale-95 overflow-hidden shadow-[6px_6px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] inline-block">
                                    <span className="relative z-10">{sips.howToAttend.cta}</span>
                                    <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                                </button>
                            </div>
                        ...
                        <div className="lg:col-span-7 order-1 lg:order-2 space-y-10">
                            <div className="animate-fade-in-up">
                                ...
                                <p className="text-xl md:text-2xl font-sans leading-relaxed text-[#2F2F2F] font-medium max-w-3xl mb-6">
                                    {sips.referrals.body}
                                </p>
                                <ul className="space-y-4 max-w-3xl">
                                    {sips.referrals.bullets.map((bullet: string, i: number) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <div className="mt-2 w-2 h-2 rounded-full bg-[#88C52A] flex-shrink-0" />
                                            <span className="text-lg md:text-xl font-sans text-[#2F2F2F] font-medium">{bullet}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                            ...
                            <div className="animate-fade-in-up delay-100 relative group">
                                <div className="relative bg-white/80 p-6 sm:p-8 md:p-10 rounded-none shadow-[6px_6px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] border-l-[6px] border-[#88C52A] transform transition-transform duration-500 group-hover:-translate-y-1">
                                    <p className="text-xl md:text-2xl font-sans italic text-[#2F2F2F] leading-tight font-semibold">
                            ...
                            <div className="space-y-8 animate-fade-in-up delay-200">
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    {sips.referrals.scenarios.map((scenario: string, i: number) => (
                                        <div key={i} className="group/card bg-white p-8 rounded-none shadow-[4px_4px_0px_0px_#88C52A] border-[3px] border-[#2F2F2F] hover:shadow-[8px_8px_0px_0px_#2F2F2F] hover:border-[#88C52A]/20 transition-all duration-500 flex flex-col justify-between h-full">
                                            <div>
                                                <div className="w-12 h-12 rounded-none bg-[#88C52A]/5 flex items-center justify-center text-[#88C52A] mb-6 font-bold text-xl group-hover/card:bg-[#88C52A] group-hover/card:text-white transition-all duration-500">
                                                    0{i + 1}
                                                </div>
                                                <p className="text-lg md:text-xl font-sans text-[#2F2F2F] leading-relaxed group-hover/card:text-[#88C52A] transition-colors duration-500">
                                                    {scenario}
                                                </p>
                                            </div>
                                            <div className="mt-8 h-1 w-12 bg-gray-100 group-hover/card:w-full group-hover/card:bg-[#88C52A] transition-all duration-700" />
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="pt-8 border-t border-gray-200 animate-fade-in-up delay-300">
                                <p className="text-2xl md:text-3xl font-heading font-bold text-[#2F2F2F] leading-tight">
            ...
            <section className="py-24 px-4 bg-gray-50/50 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#88C52A] to-transparent opacity-20" />
                ...
                <div className="sips-container mx-auto relative z-10">
                    <div className="text-center max-w-5xl mx-auto mb-20 animate-fade-in-up">
                        ...
                        <p className="text-xl md:text-2xl font-sans text-[#2F2F2F] font-medium leading-relaxed max-w-4xl mx-auto text-balance">
                            {sips.walkAway.intro}
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-20">
                        {sips.walkAway.items.map((benefit: WalkAwayItem, i: number) => (
                            <div key={i}
                                ...
                                className="group relative bg-white/80 p-6 sm:p-8 md:p-10 rounded-none shadow-[6px_6px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] hover:shadow-[8px_8px_0px_0px_#2F2F2F] transition-all duration-500 border-t-4 border-[#88C52A] flex flex-col items-start text-left animate-fade-in-up">
                                <div className="w-16 h-16 bg-[#88C52A]/5 rounded-none flex items-center justify-center mb-8 group-hover:bg-[#88C52A] group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                                    <svg className="w-8 h-8 text-[#88C52A] group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                </div>
                                <h3 className="text-2xl font-bold font-heading mb-4 text-[#2F2F2F] group-hover:text-[#88C52A] transition-colors">
                                    {benefit.title}
                                </h3>
                                <p className="text-lg font-sans leading-relaxed text-[#2F2F2F]">
                                    {benefit.text}
                                </p>
                            </div>
                        ))}
                    ...
                    <div className="text-center animate-fade-in-up delay-500">
                        ...
                        <p className="text-2xl md:text-3xl font-heading font-bold italic text-[#2F2F2F] max-w-2xl mx-auto leading-tight">
                ...
                <div className="sips-container mx-auto">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <div className="space-y-6 mb-10">
                                {sips.audience.items.map((item: string, i: number) => (
                                    <div key={i} className="flex items-start bg-gray-50 p-6 rounded-none border-l-4 border-gray-200 hover:border-[#88C52A] transition-colors">
                                        <div className="w-6 h-6 bg-[#88C52A] rounded-none shrink-0 mr-4 mt-1 flex items-center justify-center shadow-[4px_4px_0px_0px_#2F2F2F]">
                            ...
                            <div className="bg-[#88C52A] text-white p-8 rounded-none shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] transform skew-x-[-2deg]">
                        ...
                        <div className="relative">
                            ...
                            <Image src="/premium_invitation_envelope_white_1769640014114.webp" alt="Exclusive Invitation" width={800} height={800} className="relative z-10 rounded-none shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F]" />
                        </div>
                    </div>
                    {sectionCta()}
                </div>
            ...
            <section className="py-10 px-4 bg-gray-50 border-y border-[#2F2F2F] relative overflow-hidden">
                <div className="absolute inset-0 opacity-[0.02] pointer-events-none"
                    style={{ backgroundImage: 'radial-gradient(#2F2F2F 1px, transparent 1px)', backgroundSize: '30px 30px' }} />

                <div className="sips-container mx-auto text-center max-w-3xl relative z-10">
                    <div className="mb-6">
                        <span className="text-[#88C52A] font-bold tracking-[0.3em] uppercase text-[11px] md:text-[9px] block mb-2">
                            GETTING STARTED
                        </span>
                        <h2 className="text-3xl md:text-4xl font-bold font-heading mb-3 tracking-tighter">
                            {sips.howToAttend.h2}
                        </h2>
                        <p className="text-base md:text-lg font-sans text-[#2F2F2F] leading-relaxed max-w-xl mx-auto italic whitespace-pre-line">
                        ...
                        <div className="grid lg:grid-cols-3 gap-4 relative z-10">
                            {sips.howToAttend.steps.map((step: string, i: number) => (
                                <div key={i} className="group flex flex-col items-center">
                                    <div className="w-11 h-11 rounded-none bg-white border border-gray-200 flex items-center justify-center text-[#2F2F2F] font-bold text-base mb-3 shadow-[4px_4px_0px_0px_#88C52A] border-[3px] border-[#2F2F2F] group-hover:border-[#88C52A] group-hover:text-[#88C52A] transition-all duration-500 relative z-20">
                                        {i + 1}
                                        {i === 0 && <div className="absolute inset-0 rounded-none bg-[#88C52A]/10 animate-ping -z-10" />}
                                    </div>
                                    <div className="bg-white p-4 rounded-none shadow-[4px_4px_0px_0px_#88C52A] border-[3px] border-[#2F2F2F] w-full group-hover:border-[#88C52A]/20 transition-all">
                                        <p className="text-xs font-heading font-bold uppercase tracking-widest text-[#2F2F2F]">{step}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="flex flex-col items-center space-y-6">
                        <div className="relative group">
                            <button type="button" onClick={openBooking} aria-haspopup="dialog" className="px-10 py-4 bg-[#88C52A] text-[#2F2F2F] rounded-none font-bold text-lg hover:bg-[#7AB52E] transition-all transform hover:scale-105 shadow-[6px_6px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] inline-block">
                                {sips.howToAttend.cta}
                            </button>
                            <div className="absolute -top-3 -right-6 bg-[#2F2F2F] text-white text-[8px] font-bold px-2 py-0.5 rounded-none uppercase tracking-tighter shadow-[6px_6px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F]">
                                30 Seconds
                            </div>
                        </div>
            ...
            <section className="py-28 px-4 bg-white text-[#2F2F2F] relative overflow-hidden">
                <div className="absolute inset-0 opacity-[0.03] pointer-events-none"
                    style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, #2F2F2F 1px, transparent 0)', backgroundSize: '40px 40px' }} />

                <div className="sips-container mx-auto max-w-6xl relative z-10">
                    <div className="text-center mb-16 animate-fade-in-up">
                        <h2 className="text-4xl md:text-6xl font-bold font-heading tracking-tighter leading-none mb-6 max-w-4xl mx-auto text-[#2F2F2F]">
                            Your Hosts For The Evening.
                        </h2>
                        <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                            Hosted on the ground by <span className="text-[#2F2F2F] font-bold">MindFinders</span>, a DMV-based firm, in partnership with <span className="text-[#2F2F2F] font-bold">GrowersCloud.ai</span>.
                        </p>
                        <div className="w-24 h-1.5 bg-[#88C52A] mx-auto rounded-none mt-8" />
                    </div>

                    {/* Lead: Tim Booker — on-site main host */}
                    <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center mb-16 bg-white border-[3px] border-[#2F2F2F] shadow-[8px_8px_0px_0px_#2F2F2F] p-6 sm:p-8 md:p-10">
                        <div className="lg:col-span-4 relative group animate-fade-in-up">
                            <div className="relative rounded-none overflow-hidden shadow-[8px_8px_0px_0px_#2F2F2F] border-[3px] border-[#88C52A] aspect-[4/5] bg-gray-50">
                        ...
                        <div className="lg:col-span-8 space-y-5 animate-fade-in-up delay-100">
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                <span className="inline-block text-[11px] font-bold tracking-[0.25em] uppercase text-[#2F2F2F] bg-[#88C52A] px-4 py-1.5">
                                    On-Site Main Host
                                </span>
                            ...
                            <h3 className="text-3xl md:text-4xl font-bold font-heading tracking-tighter text-[#2F2F2F]">
                                {sips.coHosts.mindFinders.leaderName}
                            </h3>
                            <p className="text-base font-bold font-heading text-[#88C52A] uppercase tracking-[0.2em]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-start">
                        ...
                        <div className="bg-white border-[3px] border-[#2F2F2F] p-6 sm:p-8 md:p-10 shadow-[8px_8px_0px_0px_#2F2F2F]">
                            <div className="flex flex-col gap-5">
                                <div className="flex items-center justify-between gap-4">
                                    <span className="text-[10px] font-bold tracking-[0.08em] sm:tracking-[0.2em] uppercase text-[#88C52A] border-[2px] border-[#88C52A] px-3 py-1">
                                ...
                                <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center border-b border-gray-200 pb-5">
                                    <div className="w-40 h-52 relative rounded-none overflow-hidden border-[3px] border-[#88C52A] shadow-[4px_4px_0px_0px_#2F2F2F] shrink-0">
                                        <Image src={sips.eveningHost.photoPlaceholder} alt={sips.eveningHost.name} fill className="object-cover object-top" />
                                    </div>
                                    <div>
                                        <h3 className="text-2xl md:text-3xl font-bold font-heading text-[#2F2F2F]">{sips.eveningHost.name}</h3>
                                        <p className="text-xs font-bold tracking-widest text-[#88C52A] uppercase">{sips.eveningHost.title}</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white border-[3px] border-[#2F2F2F] p-6 sm:p-8 md:p-10 shadow-[8px_8px_0px_0px_#2F2F2F]">
                            <div className="flex flex-col gap-5">
                                ...
                                <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center border-b border-gray-200 pb-5">
                                    ...
                                    <div>
                                        <h3 className="text-2xl md:text-3xl font-bold font-heading text-[#2F2F2F]">{sips.coHosts.growersCloud.leaderName}</h3>
                                        <p className="text-xs font-bold tracking-widest text-[#88C52A] uppercase">{sips.coHosts.growersCloud.leaderTitle}</p>
                                    </div>
                                </div>
                                <div className="text-base font-sans leading-relaxed text-gray-700">
                                    {/* President Reagan and Sam Salter photo (block on mobile to prevent text squeezing, floated on sm+) */}
                                    <div className="relative w-full h-44 mb-4 sm:float-right sm:w-60 sm:h-40 sm:ml-5 sm:mb-3 rounded-none overflow-hidden border-[3px] border-[#2F2F2F] shadow-[4px_4px_0px_0px_#88C52A]">
...
{/* [9] Final Thought — closing CTA. When/Where reassurance folded in here. */}
            <section className="py-32 px-4 bg-gray-50 text-center relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-[#2F2F2F]" />
                <div className="sips-container mx-auto max-w-3xl relative z-10">
                    <h2 className="text-3xl md:text-5xl font-serif italic mb-12 leading-relaxed whitespace-pre-line text-[#2F2F2F]">
                        &ldquo;{sips.finalThought.body}&rdquo;
                    </h2>

                    <div className="flex flex-col items-center gap-6">
                        <button type="button" onClick={openBooking} aria-haspopup="dialog" className="group relative px-12 py-6 bg-[#88C52A] text-[#2F2F2F] rounded-none font-bold text-2xl hover:bg-[#7AB52E] transition-all transform hover:scale-105 shadow-[12px_12px_0px_0px_#2F2F2F] border-[3px] border-[#2F2F2F] inline-block w-full md:w-auto">
                            <span className="relative z-10">{sips.finalThought.cta}</span>
                            <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                        </button>
                        {/* When/Where reassurance rescued from the deleted Details section */}
                        <p className="text-sm font-bold text-[#2F2F2F] uppercase tracking-widest mt-2">
