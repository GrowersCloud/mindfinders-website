...
// Calendar Component - loads isolated static HTML to prevent React interference
// The actual embed code lives in /public/calendar-embed.html (outside React)
const CalendarEmbed = () => {
    return (
        <div className="w-full bg-white min-h-[1100px]">
            <iframe
                src="/calendar-embed.html"
