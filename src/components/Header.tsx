                    ...
                    <div className="group relative h-full flex items-center">
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 w-[600px] bg-white border border-[var(--border)] shadow-[var(--shadow-deep)] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-2 group-hover:translate-y-0 p-8 grid grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm">
                                    <li><Link href="/programs/ai-ceo-sips-and-growth-executive-reception" className="hover:text-[var(--primary)] block py-1">AI CEO Sips & Growth Executive Reception</Link></li>
            ...
            <div className="flex-1 relative overflow-hidden">
                ...
                >
                    ...
                    <nav className="flex flex-col gap-1">
                        ...
                        <Link href="/programs/ai-ceo-sips-and-growth-executive-reception" onClick={closeMenu} className="py-3 text-lg border-b border-gray-50">
                            AI CEO Sips & Growth Executive Reception
                        </Link>
